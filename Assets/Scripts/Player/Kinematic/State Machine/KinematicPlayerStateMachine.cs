...
/// </summary>
public class KinematicPlayerStateMachine
{
    ...
    public KinematicPlayerStateMachine(Rigidbody playerRb, CapsuleCollider playerCap, CameraController camera, Animator playerAnim)
    {
    ...
    public KinematicPlayerState currentPlayerState { get; set; }

    public void Initialize(KinematicPlayerState startingState)
    {
        currentPlayerState = startingState;
        currentPlayerState.EnterState();
    }

    public void ChangeState(KinematicPlayerState newState)
    {
