...
public class KinematicPlayerGroundedState : KinematicPlayerState
{
    public KinematicPlayerGroundedState(KinematicPlayer player, KinematicPlayerStateMachine playerStateMachine) : base(player, playerStateMachine)
    {
        _isRootState = true;
    }
