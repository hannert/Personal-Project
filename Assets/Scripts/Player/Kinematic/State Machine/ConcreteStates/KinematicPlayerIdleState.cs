...
public class KinematicPlayerIdleState : KinematicPlayerState
{
    public KinematicPlayerIdleState(KinematicPlayer player, KinematicPlayerStateMachine playerStateMachine) : base(player, playerStateMachine)
    {
    }
